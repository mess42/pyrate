...
\begin{eqnarray}
 \tilde{\Vector{e}}_\wavenumber &=& \lim_{\alpha\rightarrow0} \Vector{e}_\wavenumber + \alpha \Vector{e}_\perp \\
 \Vector{e}_\wavenumber \Vector{e}_\perp &=& 0
\end{eqnarray}

\begin{eqnarray}
 d \wavenumber^2 &=&  \wavenumber^2(\tilde{\Vector{e}}_\wavenumber) - \wavenumber^2(\Vector{e}_\wavenumber) \\
 d a_4 &=& a_4(\tilde{\Vector{e}}_\wavenumber) - a_4(\Vector{e}_\wavenumber) \\
 d a_2 &=& a_2(\tilde{\Vector{e}}_\wavenumber) - a_2(\Vector{e}_\wavenumber) \\
 d a_0 &=& 0
\end{eqnarray}
