...
From reflection law we get the following
\begin{align}
 \vec{r} &= \vec{i} - 2 \scpm{\vec{i}}{\vec{n}} \vec{n}\,.
\end{align}
From refraction we get
\begin{align}
 \vec{t} &= \frac{n_1}{n_2} \vec{i} 
 + \left[\frac{n_1}{n_2} \scpm{\vec{i}}{\vec{n}} 
      - \sqrt{1 - \left(\frac{n_1}{n_2}\right)^2 (1 - {\scpm{\vec{i}}{\vec{n}}}^2)}\right] \vec{n}\,.
\end{align}
\remark{I know that is not as elegant as the former solution by considering the field components at material boundaries :-)}
