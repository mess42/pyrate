...
\begin{align}
 ...
 \begin{pmatrix}
  \vec{Q} \\
  \vec{P} - \left[\scpm{\vec{P}}{\vec{N}(\vec{Q})} + Z(\vec{Q}) H + \sqrt{n_2^2 - \left\{n_1^2 - [\scpm{\vec{P}}{\vec{N}(\vec{Q})} + Z(\vec{Q})H]^2\right\}^2}\right] \vec{N}(\vec{Q})
 \end{pmatrix}\,,
\end{align}
...
\begin{align}
 H &\mapsto H + \left[\scpm{\vec{P}}{\vec{N}(\vec{Q})} + Z(\vec{Q}) H + \sqrt{n_2^2 - \left\{n_1^2 - [\scpm{\vec{P}}{\vec{N}(\vec{Q})} + Z(\vec{Q})H]^2\right\}^2}\right] Z(\vec{Q})\,.
\end{align}
...
\begin{align}
 ...
 \begin{pmatrix}
  \vec{Q} \\
  \vec{P} + 2(n_1 - n_2) \begin{pmatrix} c_x & 0 \\ 0 & c_y \end{pmatrix}  \vec{Q}
 \end{pmatrix} =
 \begin{pmatrix}
  1 & 0 & 0 & 0 \\
  0 & 1 & 0 & 0 \\
...
\begin{align}
 \Delta H_\text{2D} &= n_2-n_1+\frac{p_x^2}{2 n_1}+\frac{p_y^2}{2 n_1} \nonumber\\&
 -\frac{1}{2} c_x^2 q_x^2 (n_2-2 n_1)+c_x p_x q_x-\frac{1}{2} c_y^2 q_y^2 (n_2-2 n_1)+c_y p_y q_y\,.
\end{align}
