...
Later we generalize for arbitrary coordinate systems. In this set of coordinate systems, the permittivity tensor is diagonal
\begin{eqnarray}
 \permittivity &=&
 \begin{pmatrix}
...
%to do: $y \rightarrow \Wavevector \times \Vector{e}_{eo}$, $z \rightarrow \Vector{e}_{eo}, $x \propto $ \Wavevector - (\Wavevector \Vector{e}_{eo}) \Vector{e}_{eo}}
