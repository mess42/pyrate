...
which means (the second terms come from the linear expansion of the normal vector
\begin{subequations}
 \begin{align}
  {d'}_x &= \frac{n_1}{n_2} d_x + \frac{n_1}{n_2} \rho(x+\sigma d_x)\,,\\
  {d'}_y &= \frac{n_1}{n_2} d_y + \frac{n_1}{n_2} \rho(x+\sigma d_y)\,,
 \end{align}
\end{subequations}
...
\begin{align}
 ...
 \begin{pmatrix} 1 & 0 & d_1 \left(1 + d_1 \rho(1+c)\frac{n_1}{n_2}\right) + d_2 \frac{n_1}{n_2} & 0 \\ 
		  0 & 1 & 0 & d_1 \left(1 + d_1 \rho(1+c)\frac{n_1}{n_2}\right) + d_2 \frac{n_1}{n_2} \\ 
		  \frac{n_1}{n_2} \rho & 0 & \frac{n_1}{n_2} (1 + \rho d_1 (1 - \rho d_1 (1+c))) & 0 \\ 
		  0 & \frac{n_1}{n_2} \rho & 0 & \frac{n_1}{n_2} (1 + \rho d_1 (1 - \rho d_1 (1+c)))\end{pmatrix} 
...
\begin{align}
 ...
 \begin{pmatrix} 1 &  d_1 \left(1 + d_1 \rho(1+c)\frac{n_1}{n_2}\right) + d_2 \\ \frac{n_1}{n_2} \rho & \frac{n_1}{n_2} (1 + \rho d_1 (1 - \rho d_1 (1+c))) \end{pmatrix}
 \begin{pmatrix} r  \\ d \end{pmatrix}\,.
\end{align}
