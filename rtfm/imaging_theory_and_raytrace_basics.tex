...
The Maxwell equations at this level can be paired up into source and source-free equations. Every of these sub equations
...
\end{eqnarray}
and via the Gra\ss mann identity formula for the components of the time averaged Poynting vector to
\begin{eqnarray}
...
\end{align}
respectively. The factor two originates in the symmetry property of the quadrupole part. The square root is
