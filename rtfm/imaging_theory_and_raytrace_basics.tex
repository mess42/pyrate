...
\begin{eqnarray}
 \Vector{S} &=& \Re \Efield \times \Re \Hfield \nonumber \\
            ...
            &=& \underbrace{\frac{1}{2} \Re ( \Efield_0 \times \Hfield_0 \exp(-2i\omega t) )}_{\approx0} 
...
\begin{eqnarray}
  \timeavg{\Vector{S}}   &=& \frac{1}{2} \Re ( \overline{\Efield} \times \Hfield )\,.
\end{eqnarray}
...
set $\Efield = \Vector{A} \exp(i \scpm{\Vector{k}}{\Vector{x}})$ and therefore $\overline{\Efield} = \Vector{A} \exp(-i \scpm{\Vector{k}}{\Vector{x}})$.
Therefore
\begin{eqnarray}
...
and so
\begin{eqnarray}
 \timeavg{\Vector{S}}_j &=&  \frac{1}{2 \omega \vacuumpermeability}( \overline{\scalarEfield}_i \scalarEfield_i \delta_{j\ell}  - \overline{\scalarEfield}_j \scalarEfield_\ell ) k_\ell\,.
\end{eqnarray}
This expression is real (if the amplitudes $\Vector{A}$ are real) and shows that due to the last term the Poynting vector not necessarily points into direction of the wave propagtion.
