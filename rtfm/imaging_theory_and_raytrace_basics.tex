...
\section{General Derivation of Eikonal Equation}
With insertion of 
...
&=& 0\,,
\end{eqnarray}
which can be written in a more condensed form by [setting $\partial_j \to i k_j$]
\begin{align}
...
\begin{align}
 \left(z - A(x^2 + y^2) - \frac{1}{1+c}\right)^2 - \frac{1}{(1+c)^2} \left(1 -(1+c)\rho^2 (x^2 + y^2) \right) &= 0\,.
\end{align}
