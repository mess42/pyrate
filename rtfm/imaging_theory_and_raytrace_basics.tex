...
\subsubsection{Propagation through constant index $n$}
\begin{align}
 \begin{pmatrix}
  \vec{Q} \\
  \vec{P}
...
\end{align}
rest zero. Therefore\remark{check!}
\begin{align}
 \mathcal{T}_n &=
 \begin{pmatrix}
 ...
 \end{pmatrix}
\end{align}
For refraction\remark{check and complete!}
\begin{align}
 \mathcal{T}_{n_1\mapsto n_2} &=
 \begin{pmatrix}
  \delta_{\alpha\beta} & 0 &  0 & 0 & 0\\
   0                   & 1 & 0 & 0 & L\\
   0                   & 0 & \delta_{\alpha\beta} & Z(\vec{Q}) & -\biggl[\scpm{\vec{P}}{\vec{N}} - \sqrt{n_2^2 - n_1^2 + (\scpm{\vec{P}}{\vec{N}} + Z(\vec{Q}) H)^2}\biggr] N_\alpha \\
   0                   & 0 & 0 & 1 & {\color{red}{*}} \\
   0 & 0 & 0 & 0 & 1
 \end{pmatrix}
\end{align}
