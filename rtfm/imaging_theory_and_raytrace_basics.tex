...
which means (the second terms come from the linear expansion of the normal vector [we also approximate $\sigma \approx d_1$])\\
\begin{subequations}
 \begin{align}
...
\begin{itemize}
 ...
 \item Approximation of $\sigma$ by distance to surface 
