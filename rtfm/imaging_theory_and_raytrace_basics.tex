...
\begin{itemize}
 ...
 \item Therefore we need not to implement a different law of refraction for each pair of material classes.
...
\subsection{Linearization for non-zero interaction point with optical axis}
...
\begin{align}
 &\Delta \mathcal{T} = \nonumber\\&
 \begin{pmatrix}
  \partial^q_b A_{ac}|_{0} \qni{c} + A_{ab} |_{0} + \partial^q_b B_{ac} |_{0} \pni{c} + \partial^q_b t_a |_{0} &
   \partial^p_b A_{ac} |_{0} \qni{c} + \partial^p_b B_{ac} |_0 \pni{c} + B_{ab} |_0 + \partial^p_b t_a |_0 & 0\\
  \partial^q_b C_{ac}|_{0} \qni{c} + C_{ab} |_{0} + \partial^q_b D_{ac} |_{0} \pni{c} + \partial^q_b \delta_a |_{0} &
   \partial^p_b C_{ac} |_{0} \qni{c} + \partial^p_b D_{ac} |_0 \pni{c} + D_{ab} |_0 + \partial^p_b \delta_a |_0 & 0\\
  0 & 0 & 0 
 \end{pmatrix}
\end{align}
...
only deviate a little from the optical axis. All quantities have to be evaluated at the coordinates of the optical axis.
