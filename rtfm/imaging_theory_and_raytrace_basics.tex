...
\begin{align}
 L &= \int_{s_1}^{s_2} n(\Vector{r}(s), \Vector{r}'(s)) |\text{d}\Vector{s}|\,.\label{eq:fermataniso}
\end{align}
...
\begin{align}
  L &= \int_{s_1}^{s_2} \sqrt{g_{ij}(\Vector{r}(s)) \frac{\text{d}r^i}{\text{d}s} \frac{\text{d}r^j}{\text{d}s}} \text{d}s\,.\label{eq:fermataniso2}
\end{align}
For $g_{ij} = n^2(\Vector{r}) \delta_{ij}$ we get the isotropic case back.
